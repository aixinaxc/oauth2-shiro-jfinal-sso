...
import org.apache.oltu.oauth2.client.common.OAuthProviderType;
import org.apache.oltu.oauth2.client.common.exception.OAuthSystemException;
import org.apache.oltu.oauth2.client.common.message.OAuthMessage;
import org.apache.oltu.oauth2.client.common.message.types.GrantType;
import org.apache.oltu.oauth2.client.common.parameters.BodyURLEncodedParametersApplier;
import org.apache.oltu.oauth2.client.common.parameters.OAuthParametersApplier;
import org.apache.oltu.oauth2.client.common.parameters.QueryParameterApplier;
...
public class OAuthClientRequest implements OAuthMessage {
    ...
    public abstract static class OAuthRequestBuilder {
        ...
        public OAuthClientRequest buildHeaderMessage() throws OAuthSystemException {
            OAuthClientRequest request = new OAuthClientRequest(url);
            this.applier = (OAuthParametersApplier) new ClientHeaderParametersApplier();
            return (OAuthClientRequest)applier.applyOAuthParameters( request, parameters);
        }
    }
