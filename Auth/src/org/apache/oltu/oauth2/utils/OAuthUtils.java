package org.apache.oltu.oauth2.utils;
...
public final class OAuthUtils {
    ...
    /**
     * Translates org.apache.oltu.oauth2.parameters into <code>application/x-www-form-urlencoded</code> String
     *
     * @param parameters org.apache.oltu.oauth2.parameters to encode
     ...
     * @throws IOException              if an org.apache.oltu.oauth2.error occurs reading the input stream
     */
    ...
    /**
     * Creates invalid_request org.apache.oltu.oauth2.exception with given org.apache.oltu.oauth2.message
     *
     * @param message org.apache.oltu.oauth2.error org.apache.oltu.oauth2.message
    ...
    /**
     * Creates OAuthProblemException that contains set of missing oauth org.apache.oltu.oauth2.parameters
     *
     * @param missingParams missing oauth org.apache.oltu.oauth2.parameters
     * @return OAuthProblemException with user friendly org.apache.oltu.oauth2.message about missing oauth org.apache.oltu.oauth2.parameters
     */

    public static OAuthProblemException handleMissingParameters(Set<String> missingParams) {
        StringBuffer sb = new StringBuffer("Missing org.apache.oltu.oauth2.parameters: ");
    ...
    public static OAuthProblemException handleBadContentTypeException(String expectedContentType) {
        StringBuilder errorMsg = new StringBuilder("Bad org.apache.oltu.oauth2.as.request content type. Expecting: ").append(
            expectedContentType);
    ...
    public static OAuthProblemException handleNotAllowedParametersOAuthException(
        ...
        StringBuffer sb = new StringBuffer("Not allowed org.apache.oltu.oauth2.parameters: ");
        ...
        try {
            if (paramsTypes != null && paramValues != null) {
                if (!(paramsTypes.length == paramValues.length)) {
                    throw new IllegalArgumentException("Number of org.apache.oltu.oauth2.types and values must be equal");
                }
