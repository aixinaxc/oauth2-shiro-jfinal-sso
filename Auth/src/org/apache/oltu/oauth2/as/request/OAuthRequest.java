...
/**
 * The Abstract OAuth org.apache.oltu.oauth2.as.request for the Authorization server.
 */
        ...
        try {
            ...
            try {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("Cannot read redirect_url from the org.apache.oltu.oauth2.as.request: {}", new String[] {ex.getMessage()});
                }
            }
