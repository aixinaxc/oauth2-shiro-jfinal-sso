 ...
 * OAuth Token org.apache.oltu.oauth2.as.request.
 * <p/>
 * IMPORTANT: This OAuthTokenRequest assumes that a org.apache.oltu.oauth2.token org.apache.oltu.oauth2.as.request requires org.apache.oltu.oauth2.client authentication.
...
public class OAuthTokenRequest extends AbstractOAuthTokenRequest {
    ...
    /**
     * Create an OAuth Token org.apache.oltu.oauth2.as.request from a given HttpSerlvetRequest
     *
     * @param request the httpservletrequest that is validated and transformed into the OAuth Token Request
     * @throws OAuthSystemException  if an unexpected org.apache.oltu.oauth2.exception was thrown
     * @throws OAuthProblemException if the org.apache.oltu.oauth2.as.request was not a valid Token org.apache.oltu.oauth2.as.request this org.apache.oltu.oauth2.exception is thrown.
     */
